        ...
        <dashboard-title title="Define New Job Oppurtunity"></dashboard-title>
          ...
          <section class="mgt_3">
            ...
            <form id="form" action="{{ url('/jobs') }}" method="post" enctype="multipart/form-data">
              ...
              <!-- EMPLOYER -->
              <input name="employer_id" type="text" class="is-hidden" value="{{ $id }}" >
              ...
              <!-- VENUE WHERE DID YOU SEE THE POSTINGS -->
              <div class="field has-addons">
                <p class="control">
                  <a class="button is-static is-large">
                    Job posted on
              ...
              <div class="field has-addons">
                ...
                <form-tooltip title="If the date this job was posted on is unknown to you then you can refer to this as the date you found out about this job opening"></form-tooltip>
              </div>
