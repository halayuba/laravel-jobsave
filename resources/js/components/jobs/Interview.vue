  ...
  <div class="w-full card sm:w-64">
    ...
    <div class="mt-2 flex justify-between items-center">
      ...
      <div class="flex items-center">
        <h3
          :class="[ interview.status === 'Upcoming' ? 'card_header_current' : 'card_header' ]"
    ...
    <!-- POSITION -->
    <a class="mt-6 px-6 text-gray-600 text-sm"
  ...
  export default {
    ...
    methods: {
      ...
      remove(submissionId){
        ...
        this.removeJobInterview(submissionId)
          .then(response => {
