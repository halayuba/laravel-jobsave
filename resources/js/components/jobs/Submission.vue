      ...
      <div class="flex flex-col">
        <div class="flex">
          ...
          <a target="_blank"
            ...
            v-if="submission.url"
          >
            <icon name="link" class="w-4 h-4 fill-current text-indigo-400 hover:text-indigo-500 inline-block ml-1" />
          </a>
        </div>
        ...
        >
          ...
          >
            <!-- NOTES -->
            <icon name="note2" class="w-5 h-5 fill-current text-indigo-400 hover:text-indigo-500" />
          </picture>
        ...
        >
          <div class="flex items-center">
            ...
            >
              <icon name="calendar" class="w-5 h-5 fill-current text-indigo-400 hover:text-indigo-500" />
            </picture>
            <span class="ml-1">{{ upcomingInterviewFullRecord.dateTime }}</span>
          </div>

          <!-- INTERVIEW DETAILS -->
          <div class="flex flex-col mt-2 bg-gray-200 p-2"
          ...
          >
            ...
            >
              <icon name="note" class="w-6 h-6 fill-current text-gray-600" />
